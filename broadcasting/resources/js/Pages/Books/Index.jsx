              ...
              <div className="flex h-full flex-col justify-between py-2">
                <div>
                  ...
                  <SidebarItems className="pb-32">
                    <SidebarItemGroup>
                      <p className="flex items-center justify-center pt-2 pb-3 text-lg font-semibold leading-none">Manage Books</p>
                      ...
                      <SidebarItem
                        href="#"
                        icon={HiPencilAlt}
                        onClick={() => setModalBookUpdate(true)}>
                        Update
                      </SidebarItem>
                      ...
                      <SidebarItem
                        ...
                        onClick={() => setModalBookSearch(true)}>
                        Search
                      </SidebarItem>
                      ...
                      <SidebarItem
                        href="#"
                        icon={HiOutlineTrash}
                        onClick={() => setModalBookDelete(true)}>
                        Delete
                      </SidebarItem>
                    </SidebarItemGroup>
                    <SidebarItemGroup>
